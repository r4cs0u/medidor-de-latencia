  ...
  function init() {
    ...
    function applyGlobalPx(v) {
      ...
      ML.CHANNELS.forEach(ch => {
        if (ch.probeW == null) { if (ch._szInp) ch._szInp.value = c; if (ch.active && ch.resize) ch.resize(); }
      });
    }
    ...
    rowToggle.style.marginBottom = '5px';
    ...
    const rowBtns = row(6);
    rowBtns.style.marginBottom = '6px';
    ...
    console.log('[MedLat] 50-panel carregado — layout Telas/Grid/Detalhamento/Analise.');
  }
